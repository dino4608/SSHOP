...
const FlashSaleSection: React.FC = () => {
    ...
    return (
        <HomeContainer>
            <div className="bg-white p-4 space-y-4 rounded-lg border border-gray-200 relative">
                {/* title */}
                ...
                {startIndex > 0 && (
                    <button
                        ...
                        className="
                            ...
                            bg-white w-10 h-10 border rounded-full p-1 shadow hover:bg-gray-100
                            flex items-center justify-center"
                    >
                        <ChevronLeft className="w-5 text-[var(--dino-red-1)]" />
                    </button>
                )}
                {startIndex < maxIndex && (
                    <button
                        ...
                        className="
                            ...
                            bg-white w-10 h-10 border rounded-full p-1 shadow hover:bg-gray-100
                             flex items-center justify-center"
                    >
                        <ChevronRight className="w-5 text-[var(--dino-red-1)]" />
                    </button>
                )}
                ...
                <div className="grid grid-cols-6 gap-4 transition-all ease-in-out">
                    {visibleProducts.map((item) => (
                        <div key={item.id} className="overflow-hidden">
                            <div className="aspect-[1/1] bg-white relative">
                                {/* product image */}
                                <Image
                                    src={item.image}
                                    alt={item.title}
