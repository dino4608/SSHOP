...
const Header: React.FC = () => {
    ...
    return (
        <header className='bg-white text-[var(--dino-red-1)] w-full px-2 sm:px-10 lg:px-20 py-2 sm:py-4 border-b border-gray-200 shadow-sm backdrop-blur-sm sticky top-0 z-50'>
