import { TProductDescription, TProductSpecification } from "@/types/product.types";
...
const ProductDescription = ({ product }: TProductDescriptionProps) => {
        ...
        <div className="p-4 rounded-lg border border-gray-200 space-y-4">
            ...
            {product.specifications.length > 0 && (
                <div className="space-y-4 text-sm">
                    <div className="text-gray-500 font-medium">Specifications</div>
