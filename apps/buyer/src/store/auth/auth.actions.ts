...
export async function validateSessionToken(token: string): Promise<SessionValidationResult> {
    ...
    const result: any = null; // = await prisma.session.findUnique({
    //     where: {
    //         id: sessionId
    //     },
    //     include: {
...
export const registerUser = async (email: string, password: string) => {
    ...
    try {
        const user: any = null; // await prisma.user.create({
        //     data: {
        //         email,
        //         passwordHash,
        //     }
...
export const loginUser = async (_email: string, password: string) => {
